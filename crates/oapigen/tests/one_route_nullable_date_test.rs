...
fn one_route_nullable_date_test(#[case] name: &str, #[case] library: oapigen::DateTimeLibraries) {
    ...
    let f = std::fs::File::open("fixtures/one_route_date_nullable.yaml").unwrap();
